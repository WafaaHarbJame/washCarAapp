...
//        holder.binding.reviewTv.text = reviewModel?.comment
//        holder.binding.tvUserName.text = reviewModel?.userName
//        holder.binding.ratingBar.rating = reviewModel?.rate?.toFloat() ?: 0f
    ...
    inner class Holder(var binding: RowItemReviewBinding) : RecyclerView.ViewHolder(
        binding.root
    )
}